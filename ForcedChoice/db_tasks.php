				...
				while (!feof($handle)) {
					...
					// database
						...
						if (empty($buffer)) {
							...
							$query = "INSERT INTO answers(qv_no, filetag, correctness, answer) VALUES('" . $qv_no_a . "','" . $filetag . "','" . (int)$answer[1] . "','" . pg_escape_string($answer[2]) . "');";
							ask_pg($client_credentials, $query);
						}
					}
				}
