...
if (isset($_POST['db_submitter'])) {
	...
	switch ($request){
		...
		// These text file will indicate the number of sessions, the name of each session,
				...
				while (!feof($handle)) {
					...
					// database
						...
						if (empty($buffer)) {
							...
							$query = "INSERT INTO answers(qv_no, filetag, answer) VALUES('" . $qv_no_a . "','" . $filetag . "','" . $answer . "');";
							ask_pg($client_credentials, $query);
						}
					}
				}
